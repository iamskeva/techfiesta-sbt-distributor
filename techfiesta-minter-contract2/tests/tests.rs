//! Tests for the `techfiestar_minter_contract1` contract.
use concordium_cis2::*;
use concordium_smart_contract_testing::*;
use concordium_std::collections::BTreeSet;
use concordium_std_derive::*;
use techfiestar_minter_contract1::*;
...
#[test]
fn test_minting() {
    let (chain, contract_address, _update) = initialize_contract_with_alice_tokens();
        ...
        .contract_invoke(
            ...
            UpdateContractPayload {
                ...
                receive_name: OwnedReceiveName::new_unchecked(
                    "techfiestar_minter_contract1.view".to_string(),
                ),
    ...
    let update = chain
        .contract_update(
            ...
            UpdateContractPayload {
                amount: Amount::zero(),
                receive_name: OwnedReceiveName::new_unchecked(
                    "techfiestar_minter_contract1.transfer".to_string(),
                ),
                address: contract_address,
    ...
    let update = chain
        .contract_update(
            ...
            UpdateContractPayload {
                amount: Amount::zero(),
                receive_name: OwnedReceiveName::new_unchecked(
                    "techfiestar_minter_contract1.updateOperator".to_string(),
                ),
                address: contract_address,
    ...
    let invoke = chain
        .contract_invoke(
            ...
            UpdateContractPayload {
                amount: Amount::zero(),
                receive_name: OwnedReceiveName::new_unchecked(
                    "techfiestar_minter_contract1.operatorOf".to_string(),
                ),
                address: contract_address,
...
fn initialize_contract_with_alice_tokens() -> (Chain, ContractAddress, ContractInvokeSuccess) {
    ...
    let mint_params = MintParams {
        ...
        token_metadata_base_url: String::from(TOKEN_METADATA_BASE_URL),
    };
    ...
    let update = chain
        .contract_update(
            ...
            UpdateContractPayload {
                amount: Amount::zero(),
                receive_name: OwnedReceiveName::new_unchecked(
                    "techfiestar_minter_contract1.mint".to_string(),
                ),
                address: contract_address,
        ...
        .contract_init(
            ...
            InitContractPayload {
                ...
                init_name: OwnedContractName::new_unchecked(
                    "init_techfiestar_minter_contract1".to_string(),
                ),
